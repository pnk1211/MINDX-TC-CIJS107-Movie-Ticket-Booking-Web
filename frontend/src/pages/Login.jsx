  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-black/60">
      <div className="bg-white rounded-xl w-[400px] p-6 relative">
        ...
        <button className="w-full bg-orange-500 text-white py-3 rounded-lg font-semibold">ĐĂNG NHẬP</button>

        <p className="text-sm text-center mt-4">
          Bạn chưa có tài khoản?{" "}
          <a href="/register" className="text-orange-500 font-semibold">Đăng ký</a>
        </p>
